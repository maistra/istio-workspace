...
image:https://travis-ci.org/aslakknutsen/istio-workspace.svg["Travis", link="https://travis-ci.org/aslakknusten/istio-workspace"]
...
[source,bash]
----
$ git clone https://github.com/aslakknusten/istio-workspace $GOPATH/src/github.com/aslakknusten/istio-workspace
----
