...
func createDevelopNewCmd() *cobra.Command {
	...
	newCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			basicNewService(serviceName, deploymentType.String(), ns, func(object runtime.Object) {
...
func basicNewService(name, deploymentType, ns string, printer generator.Printer) {
