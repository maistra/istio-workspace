...
func createDevelopNewCmd() *cobra.Command {
	newCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			var collect generator.Printer
			var objectsToCreate []runtime.Object
			collect = func(object runtime.Object) {
				objectsToCreate = append(objectsToCreate, object)
			}
			scenarios.BasicNewService(collect, name, cmd.Flag("namespace").Value.String())
