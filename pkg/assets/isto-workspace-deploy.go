...
func deployIstioWorkspaceRoleYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/role.yaml", size: 1045, mode: os.FileMode(436), modTime: time.Unix(1564730427, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func deployIstioWorkspaceCrdsIstio_v1alpha1_session_crdYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/crds/istio_v1alpha1_session_crd.yaml", size: 303, mode: os.FileMode(436), modTime: time.Unix(1564730333, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
