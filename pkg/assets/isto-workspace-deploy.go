...
func deployIstioWorkspaceRole_binding_localYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/role_binding_local.yaml", size: 539, mode: os.FileMode(436), modTime: time.Unix(1565345780, 0)}
...
func deployIstioWorkspaceOperatorYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/operator.yaml", size: 2123, mode: os.FileMode(436), modTime: time.Unix(1565346160, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func deployIstioWorkspaceRole_localYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/role_local.yaml", size: 1038, mode: os.FileMode(436), modTime: time.Unix(1565345780, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
