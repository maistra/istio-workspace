...
func deployIstioWorkspaceOperatorYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/operator.yaml", size: 1840, mode: os.FileMode(436), modTime: time.Unix(1575032170, 0)}
...
func deployIstioWorkspaceRole_localYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/role_local.yaml", size: 1173, mode: os.FileMode(436), modTime: time.Unix(1584453242, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func deployIstioWorkspaceRoleYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/role.yaml", size: 1180, mode: os.FileMode(436), modTime: time.Unix(1584453256, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
