...
func deployIstioWorkspaceOperatorTplYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/operator.tpl.yaml", size: 1840, mode: os.FileMode(436), modTime: time.Unix(1576151180, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
