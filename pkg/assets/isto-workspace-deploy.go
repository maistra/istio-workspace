...
func deployIstioWorkspaceOperatorYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/operator.yaml", size: 1441, mode: os.FileMode(436), modTime: time.Unix(1560343312, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func deployIstioWorkspaceRole_bindingYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "deploy/istio-workspace/role_binding.yaml", size: 476, mode: os.FileMode(436), modTime: time.Unix(1560343312, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
